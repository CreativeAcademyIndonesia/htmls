				...
				<div class="container">
					<div class="row justify-content-center mb-5">
						<div class="col-xl-6 col-lg-8 text-center">
							<h3 class="h1 fw-bold mb-3">LAKIP 2022 RSUD POSO</h3>
						</div>
					</div>
<center>					
<embed type="application/pdf" src="LAKIP2022RSUDPOSO.pdf" width="1200" height="1000"></embed>
...
<section id="content">
			<div class="content-wrap min-vh-30 d-flex align-items-center">
				<div class="container">
					<div class="row justify-content-center mb-5">
						<div class="col-xl-6 col-lg-8 text-center">
							<h3 class="h1 fw-bold mb-3">RENJA 2023 RSUD POSO </h3>
						</div>
					</div>
					
<embed type="application/pdf" src="RENJA2023.pdf" width="1200" height="1000"></embed>
</center>
