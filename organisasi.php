...
<center>
<img src="images/Profil_Organisasi.png">
</center>
				...
				<div class="container">
					...
					<div class="row col-mb-50 mb-0">
						...
						<div class="col-lg-6">
							...
							<p>Poso Menjadi Kabupaten Maju, Tangguh, dan Terdepan di Sulawesi Tengah</p>
						...
						<div class="col-lg-6">
							...
							<p>
								...
								<ol>
									...
									<li>Mewujudkan pengelolaan Sumber Daya Alam Unggulan Daerah Berbasis Kawasan melalui Tata Kelola Desa yang Akuntabel, Transparan, Inovatif, Produktif menuju Desa Maju</li><br>

									<li>Mewujudkan kualitas kesehatan masyarakat menuju Poso Sehat</li><br>

									<li>Mewujudkan Pendidikan yang Terjangkau, Berkualitas dan Inklusif menuju Poso Pintar</li><br>

									<li>Mewujudkan perekonomian Masyarakat dan Daerah yang sejahtera dan berdaya saing melalui pengembangan potensi sumberdaya lokal</li><br>

									<li>Mewujudkan pemerintahan yang responsif, profesional, transparan, melayani, bekerja tuntas, inovatif, dan akuntabel</li><br>

									<li>Mewujudkan kehidupan masyarakat Poso yang Harmoni dan Tangguh Bencana, sadar akan Lingkungan Berkelanjutan, Toleran, dan Damai</li><br>

									<li>Mewujudkan Kota Poso sebagai kota Transit yang ramah, Indah dan nyaman, dengan infrastruktur, yang terdepan dan merata di seluruh wilayah</li>
